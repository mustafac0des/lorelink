        ...
        <View style={styles.headerContent}>
          <View style={styles.userInfo}>
            ...
            <View style={styles.businessInfo}>
              ...
              <Text style={styles.infoText}>✍️ Crafting tales that resonate</Text>
              <Text style={styles.infoText}>📚 Building worlds with words</Text>
              <Text style={styles.infoText}>🎯 Inspiring through stories</Text>
            </View>

            <TouchableOpacity style={styles.followersRow}>
              <Text style={styles.followersText}>256 followers</Text>
              <Text style={styles.dotSeparator}>·</Text>
              <Text style={styles.linkText}>threads.net</Text>
            </TouchableOpacity>
